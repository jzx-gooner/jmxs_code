...
def addCamera():
    ...
    content = request.form['address[US]'] 
    id = request.form['address[US]'] 
    ext = request.form['address[US]'] 
    user = request.form['address[US]'] 
    password = request.form['address[US]'] 
    ip = request.form['address[US]'] 
    port = request.form['address[US]'] 
    options = request.form['address[US]'] 
